...
import { AccessLevel, EmployeeStatusCode, PermissionPage } from '@dealer-portal/polaris-core';
...
export type UserValueType =
  ...
  | BaseEntity
  | EmployeeStatusCode
  | Array<BaseEntity | Dealer | ProductLine | Partial<PermissionPage>>;
...
export class User {
  ...
  public employeeStatusCode: EmployeeStatusCode = EmployeeStatusCode.Inactive;
  ...
  public vendorNumber: string | null = null;
