...
export const environment: HomepageEnvironment = ((): HomepageEnvironment => {
  ...
  return {
    ...
    appInsights: {
      connectionString:
        'InstrumentationKey=cf958d26-f110-4903-8c51-3e1a5c60f32a;IngestionEndpoint=https://eastus-8.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus.livediagnostics.monitor.azure.com/;ApplicationId=99c917e8-3cd5-42b5-93f0-7465853b0b7b',
    ...
    endpoints: {
      ...
      newsUrl: { baseUrl: 'https://home-dev.polarisportal.com/Home/News' },
