...
export const environment: Environment = ((): Environment => {
  ...
  return {
    ...
    appInsights: {
      connectionString:
        'InstrumentationKey=34780f06-4985-4016-a957-3af2651b68f5;IngestionEndpoint=https://eastus-8.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus.livediagnostics.monitor.azure.com/;ApplicationId=1db0aabf-6762-4e54-9c80-857da5647427',
