...
export const environment: Environment = ((): Environment => {
  ...
  return {
    applicationName: '<APPLICATION-NAME>', // Replace with your application name registered in the portal
    ...
    translations: {
      appName: '<APPLICATION-NAME>', // Replace with your application name registered in the portal
